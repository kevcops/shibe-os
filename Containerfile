...
RUN rpm-ostree install libreoffice simple-scan tailscale vlc thunderbird chromium firefox gnome-boxes flameshot pinta plasma-desktop sddm kde-settings kscreen plasma-workspace plasma-nm plasma-pa kwalletmanager dolphin konsole ark --apply-live
...
COPY systemd/yafti-autostart.desktop /etc/xdg/autostart/yafti-autostart.desktop
